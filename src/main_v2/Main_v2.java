...
public class Main_v2 {
    ...
    public final static String consoleVersion = "1.05";

    public static void buildDatabase(ArgumentsParser_v2 argsParser) throws IOException, ClassNotFoundException {
    ...
    public static void doPlacement(ArgumentsParser_v2 argsParser) {
